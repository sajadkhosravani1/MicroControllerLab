...
_0x3:
	...
	.DB  0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x50,0x72,0x6F,0x67,0x72,0x61,0x6D,0x6D
	.DB  0x65,0x64,0x20,0x62,0x79,0x3A,0x20,0x53
	.DB  0x61,0x6A,0x61,0x64,0x20,0x4B,0x68,0x6F
	.DB  0x73,0x72,0x61,0x76,0x61,0x6E,0x69,0x20
	.DB  0x39,0x36,0x31,0x31,0x32,0x30,0x30,0x31
	.DB  0x33,0x20,0x0
_0x0:
	.DB  0x48,0x45,0x4C,0x4C,0x4F,0x20,0x57,0x4F
	.DB  0x52,0x4C,0x44,0x0
_0x2000003:
	.DB  0x80,0xC0
...
;
;void move(char str[],int n, int row, int ms);
;
...
_main:
; .FSTART _main
; 0000 0031     char str[59] = "                Programmed by: Sajad Khosravani 961120013 ";
; 0000 0032     int len = 59;
; 0000 0033     play = false;
	SBIW R28,59
	LDI  R24,59
	LDI  R26,LOW(0)
	LDI  R27,HIGH(0)
...
; 0000 007E // INT1: On
; 0000 007F // INT1 Mode: Rising Edge
; 0000 0080 // INT2: Off
; 0000 0081 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0082 MCUCR=(1<<ISC11) | (1<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(14)
	OUT  0x35,R30
; 0000 0083 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0084 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0085 
...
_0x4:
; 0000 00B0       {
; 0000 00B1         lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00B2         lcd_puts("HELLO WORLD");
	__POINTW2MN _0x7,0
	RCALL _lcd_puts
; 0000 00B3         move(str,len,1,15);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	ST   -Y,R17
...
_move:
; .FSTART _move
; 0000 00B9     int i,icopy,j;
; 0000 00BA     char showstr[16];
; 0000 00BB 
; 0000 00BC     for (i=0; i<n; i++) {
	ST   -Y,R27
	ST   -Y,R26
	SBIW R28,16
	CALL __SAVELOCR6
...
_0xA:
	...
	CPC  R17,R31
	BRGE _0xB
; 0000 00BD         while(!play);
_0xC:
	TST  R5
	BREQ _0xC
; 0000 00BE         lcd_gotoxy(0,row);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDD  R26,Y+25
	RCALL _lcd_gotoxy
; 0000 00BF         icopy=i;
	MOVW R18,R16
; 0000 00C0 
; 0000 00C1         for(j=0; j<16; j++)
	__GETWRN 20,21,0
_0x10:
	__CPWRN 20,21,16
	BRGE _0x11
; 0000 00C2             showstr[j] = str[icopy++];
	MOVW R30,R20
	MOVW R26,R28
	ADIW R26,6
	ADD  R30,R26
	...
	RJMP _0x10
_0x11:
; 0000 00C4 lcd_puts (showstr);
	MOVW R26,R28
	ADIW R26,6
	RCALL _lcd_puts
; 0000 00C5         delay_ms(ms);
	LDD  R26,Y+22
	LDD  R27,Y+22+1
	CALL _delay_ms
; 0000 00C6     };
