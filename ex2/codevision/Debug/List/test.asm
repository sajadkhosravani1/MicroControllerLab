...
_main:
; .FSTART _main
; 0000 0023     char str[59] = "                Programmed by: Sajad Khosravani 961120013 ";
; 0000 0024     int len = 59;
; 0000 0025 
...
_0x4:
; 0000 009A       {
; 0000 009B         lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 009C         lcd_puts("HELLO WORLD");
	__POINTW2MN _0x7,0
	RCALL _lcd_puts
; 0000 009D         move(str,len,1,15);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	ST   -Y,R17
...
_move:
; .FSTART _move
; 0000 00A3     int i,icopy,j;
; 0000 00A4     char showstr[16];
; 0000 00A5 
; 0000 00A6     for (i=0; i<n; i++) {
	ST   -Y,R27
	ST   -Y,R26
	SBIW R28,16
	CALL __SAVELOCR6
...
; 0000 00A8         icopy=i;
	MOVW R18,R16
; 0000 00A9 
; 0000 00AA         for(j=0; j<16; j++)
	__GETWRN 20,21,0
_0xD:
	__CPWRN 20,21,16
	BRGE _0xE
; 0000 00AB             showstr[j] = str[icopy++];
	MOVW R30,R20
	MOVW R26,R28
	ADIW R26,6
	ADD  R30,R26
	...
	RJMP _0xD
_0xE:
; 0000 00AD lcd_puts (showstr);
	MOVW R26,R28
	ADIW R26,6
	RCALL _lcd_puts
; 0000 00AE         delay_ms(ms);
	LDD  R26,Y+22
	LDD  R27,Y+22+1
	CALL _delay_ms
; 0000 00AF     };
